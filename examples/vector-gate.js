...
import { demoCorpus, CLOCK as clock, nodeName as nodeNameOf } from '../src/demo-corpus.js';

const { graph, text: TEXT, personas: PERSONAS } = demoCorpus();
const say = (s) => console.log(s);
const line = () => say('─'.repeat(66));
const nodeName = (id) => nodeNameOf(graph, id);
